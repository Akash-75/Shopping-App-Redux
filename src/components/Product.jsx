...
const Product = ({post}) => {
    ...
    return (
        ...
        <div className=" flex flex-col items-center justify-between hover:scale-110 transition duration-300 ease-in gap-3 p-4 mt-10 ml-5 rounded-xl  shadow-[rgba(0,_0,_0,_0.4)_0px_30px_90px]">
            <div>
